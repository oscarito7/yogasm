...
<div class="woocommerce_account_subscriptions">
	...
	<?php else : ?>
			<?php if ( 1 < $current_page ) : ?>
				...
				?>
				<div class="container-s my-mat">
					<p>No tienes ninguna suscripción...</p>
					<button class="btn btn-primary btn-jumbo" onclick="window.location.href='<?php echo home_url()."/completar-alta/"; ?>'">Completar alta</button>
				</div>
			<?php
		endif; ?>
		</p>
