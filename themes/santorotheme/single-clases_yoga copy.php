...
<?php 
  ...
  **/
  ...
  if ( (get_field('plan') == "Gratis") || ($current_user_es_regalo == "si")) {
    ...
    ?>   
      ...
      <div class="container-l">
            ...
            <div id="js-reproductor-CTA" class="reproductor-CTA-clase reproductor-CTA-clase-visible">
                    ...
                    <?php } ?>
                      ...
                      <div js="js-reproductor-CTA-description-clase" class="reproductor-CTA-description-clase reproductor-CTA-description-clase-no-visible"> 
  ...
  <script type="application/javascript">
          ...
          /*esto es porque no soy capaz por css de que un div ocupe el espacio del vídeo y si no lo hago hace un salto muy raro al cargar el vídeo*/
          var reproductorCTA = document.getElementById("js-reproductor-CTA"); 
          reproductorCTA.classList.remove("reproductor-CTA-clase-visible");
